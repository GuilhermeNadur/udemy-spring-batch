...
public class CriacaoContasStepConfig {
	...
	@Bean
	public Step criacaoContasStep(ItemReader<Cliente> leituraClientesReader, ItemProcessor<Cliente, Conta> geracaoContaProcessor, ItemWriter<Conta> impressaoContaWriter) {
